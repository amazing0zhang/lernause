...
class Movie(models.Model):
    ...
    name = models.CharField(verbose_name="景点名称", max_length=255, unique=True)
    director = models.CharField(verbose_name="景点地址", max_length=255)
    country = models.CharField(verbose_name="国家", max_length=255)
    years = models.DateField(verbose_name='日期')
    leader = models.CharField(verbose_name="其他", max_length=1024)
