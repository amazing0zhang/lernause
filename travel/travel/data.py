...
# sys.path.extend(['D:\\github\\travel-recommendation-system\\python-django\\movieSystem', ])
os.environ.setdefault("DJANGO_SETTINGS_MODULE", "travelrecomend.settings")
...
def get_url_movie():
    ...
    while urls:
        ...
        for movie_href in movie_hrefs:
            print('fetch travel href', movie_href)
